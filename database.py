...
if __name__ == '__main__':
    with psycopg2.connect(database="database", user="postgres",
                          password="03091988") as conn:
        with conn.cursor() as curs:
            ...
            print("Добавлен id клиента: ",
                  insert_client(curs, "Егор", "Сорокин", "egorka_sorokin@mail.ru"))
            print("Добавлен id клиента: ",
                  insert_client(curs, "Алина", "Титова",
                                "alilonchic@mail.ru", 79214481765))
            print("Добавлен id клиента: ",
                  insert_client(curs, "Виктор", "Логвинов",
                                "morgot_87@mail.ru", 79313332345))
            print("Добавлен id клиента: ",
                  insert_client(curs, "Дмитрий", "Викторов",
                                "dima@mail.ru", 79913312643))
            print("Добавлен id клиента: ",
                  insert_client(curs, "Ольга", "Титова",
                                "titova@mail.ru"))
            ...
            print("Изменены данные id клиента: ",
                  update_client(curs, 4, "Петр", None, 'qwerty@mail.ru'))
            ...
            pprint(find_client(curs, 'Егор'))

            print('Найденный клиент по email:')
            pprint(find_client(curs, None, None, 'morgot_87@mail.ru'))

            print('Найденный клиент по имени, фамилии и email:')
            pprint(find_client(curs, 'Егор', 'Сорокин',
                               'egorka_sorokin@mail.ru'))

            print('Найденный клиент по имени, фамилии, телефону и email:')
            pprint(find_client(curs, 'Виктор', 'Логвинов',
                               'morgot_87@mail.ru', '79313332345'))
